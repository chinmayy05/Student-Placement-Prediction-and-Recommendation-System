...
if prediction_button:
    ...
    with open('placement.pkl', 'rb') as placementfile:
        placement = pickle.load(placementfile)
    with open('placement.pkl', 'rb') as companyfile:
    ...
    def prediction_Recommendation(df):
        ...
        s4='To Enhance your Placement preparation, We Recommend you the following skills: '
